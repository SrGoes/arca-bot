...
class TestPermissionManager(unittest.TestCase):
    ...
    def test_owner_permissions(self):
        ...
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.OWNER))
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.ADMIN))
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.ECONOMY_ADMIN))
    ...
    def test_admin_permissions(self):
        ...
        self.assertFalse(self.permission_manager.has_permission_level(mock_user, PermissionLevel.OWNER))
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.DISCORD_ADMIN))
    ...
    def test_economy_admin_permissions(self):
        ...
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.ECONOMY_ADMIN))
        self.assertFalse(self.permission_manager.has_permission_level(mock_user, PermissionLevel.ADMIN))
    ...
    def test_user_permissions(self):
        ...
        self.assertTrue(self.permission_manager.has_permission_level(mock_user, PermissionLevel.USER))
        self.assertFalse(self.permission_manager.has_permission_level(mock_user, PermissionLevel.ECONOMY_ADMIN))
...
class TestCacheManager(unittest.TestCase):
    ...
    def test_disabled_cache(self):
        ...
        disabled_cache_manager.get_stats.return_value = {
            'enabled': False
        }
